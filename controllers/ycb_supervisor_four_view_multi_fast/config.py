...
POST_ARRIVAL_PAUSE_SEC = 0.4
ARM_MOTOR_VELOCITY_RAD_PER_SEC = 1.5
ARM_SETTLE_TIME_BUFFER_SEC = 0.5
ASSET_BASE   = "../urdfs/ycb_assets"

# ── 資料集拍攝排程 ────────────────────────────────────────
# 多物體場景改由外部生成程式輸出成 MULTI_SCENE_FILE，
# supervisor 啟動時只會讀取該檔案。
DATASET_CAPTURE_MODE = "multi"
